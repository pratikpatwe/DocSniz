...
export default function HowItWorksSection() {
  return (
    <section className="relative overflow-hidden bg-gray-50 flex flex-col items-center">
      <div className="py-12 lg:py-24 max-w-5xl max-auto px-4 sm:px-6 lg:px-8">
        <div
          aria-hidden="true"
    ...
    -translate-x-1/2 bg-linear-to-br from-rose-300 via-rose-300 to-rose-300 
