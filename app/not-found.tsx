...
export default function NotFoundPage() {
  return (
    <section className="flex flex-col items-center justify-center min-h-screen p-6 text-center">
      {/* Simple badge */}
      <Badge variant={'secondary'} className="px-4 py-2 mb-6 text-base font-medium bg-white rounded-full border border-rose-200">
      ...
      <div className="flex flex-col sm:flex-row gap-4 mt-4">
        <Button className="bg-gradient-to-r from-slate-900 to-rose-500 hover:from-rose-500 hover:to-slate-900 text-white rounded-full px-6 py-2 font-medium">
        ...
        <Button variant="outline" className="text-rose-600 border-rose-200 rounded-full px-6 py-2 hover:bg-rose-50">
